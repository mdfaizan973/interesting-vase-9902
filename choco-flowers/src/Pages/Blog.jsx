    ...
    <Container marginTop={"20px"} maxW={"7xl"} p="12">
      ...
      >
        ...
        >
          ...
          >
            ...
            you’re moving your body or moving ideas forward, aim to move in the
            direction of progress. Day after day, find time to lace up your gym
            shoes and get in your workout, wherever, whenever and whatever it
            might be. There’s no one way approach fitness as long as you’re
            living an active life. If you’re passionate about running,
            weightlifting, cross training or studio workouts, Reebok has a range
            of athletic shoes designed to support you with technology and
            comfort. And no matter how you move, do it with purpose and style.
            Reebok’s retro sneakers were born from sports out of the 80s and
            90s. Then, they were gamechangers on the basketball and tennis
            courts, track and trails. Now, they’re timelessly authentic classic
            shoes. Iconic since day one.
          </Text>
        </Box>
      </Box>
      ...
      <VStack paddingTop="40px" spacing="2" alignItems="flex-start">
        ...
        <Text as="p" fontSize="lg">
          ...
          streetwear essentials. Like NMD, Ozweego and our Firebird tracksuits.
          Classic sports models are brought back to life. Like Stan Smith. And
          Superstar. Now seen on the streets and the stages.
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          worn as sportswear too. Our lives are constantly changing. Becoming
          more and more versatile. And adidas designs with that in mind.
        </Text>
      </VStack>
    </Container>
  );
